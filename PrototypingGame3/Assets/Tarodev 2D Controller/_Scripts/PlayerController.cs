    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        private void GatherInput() {
            Input = new FrameInput {
                JumpDown = UnityEngine.Input.GetButtonDown("Jump") || UnityEngine.Input.GetKeyDown(KeyCode.W),
                JumpUp = UnityEngine.Input.GetButtonUp("Jump") || UnityEngine.Input.GetKeyUp(KeyCode.W),
